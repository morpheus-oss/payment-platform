 ...
 *
 * <p>For example database failures, messaging failures,
 * serialization errors and network communication issues.
 *
 * <p>Infrastructure exceptions should never be used to represent
