 ...
 *
 * <p>All application, domain and infrastructure exceptions should extend this type. The exception
 * carries a strongly typed {@link ErrorCode} that can later be translated into RFC 9457 Problem
 * Details, structured logs and metrics.
 */
public abstract class PlatformException extends RuntimeException {
  ...
  protected PlatformException(
      final ErrorCode errorCode, final ErrorContext errorContext, final Throwable cause) {
