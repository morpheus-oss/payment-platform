 ...
 *
 * <p>Domain exceptions represent failures caused by business invariants, validation rules or domain
 * policies. They are deterministic and should not depend on external systems.
 */
